...
"""
antifraud_trie.py: https://github.com/InsightDataScience/digital-wallet
Implementation of simple antifraud filter using trie.
This requires an install: pip install pygtrie
"""
__author__ = "S Irwin"
__version__ = "0.0.1"
